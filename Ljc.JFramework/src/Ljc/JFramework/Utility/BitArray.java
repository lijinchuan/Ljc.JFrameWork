...
public class BitArray {
	...
	/**
	 * Creates a BitArray of the specified size, initialized from the specified byte
	 * array. The most significant bit of a[0] gets index zero in the BitArray. The
	 * array a must be large enough to specify a value for every bit in the
	 * BitArray. In other words, 8*a.length <= length.
	 */
	public BitArray(int length, byte[] a) throws IllegalArgumentException {
		...
		/*
		 * normalize the representation: 1. discard extra bytes 2. zero out extra bits
		 * in the last byte
		 */
	...
	/**
	 * Returns a Byte array containing the contents of this BitArray. The bit stored
	 * at index zero in this BitArray will be copied into the most significant bit
	 * of the zeroth element of the returned byte array. The last byte of the
	 * returned byte array will be contain zeros in any bits that do not have
	 * corresponding bits in the BitArray. (This matters only if the BitArray's size
